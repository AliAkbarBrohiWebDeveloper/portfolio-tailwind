...
const Header = () => {
  return (
    <section>
        ...
        <header className="sticky top-0 z-50 shadow-lg bg-black text-white px-3">
          <main className="flex justify-between items-center px-6 py-3 h-20">
            {/* Left side: Title */}
            <div>
              <h1 className="text-2xl font-bold text-white">Ali Akbar Brohi</h1>
            </div>
            ...
            {/* Mobile Menu Button */}
            <Sheet>
              <SheetTrigger className="md:hidden text-3xl text-white">
                <Menu />
              </SheetTrigger>

              <SheetContent side="left" className="bg-black p-6 text-white">
                <SheetHeader>
                  <SheetTitle className="text-2xl font-semibold text-center mb-4">Menu</SheetTitle>
                  <SheetDescription>
